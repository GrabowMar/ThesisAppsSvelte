```markdown
# Reservation Application Template - Flask + react
...
**Reservation System**  
A booking application built with Flask and react, featuring time slot management and reservation handling.
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=int(os.getenv('PORT', '5103')))
```
...
1. **Port Configuration Prompt**
   - Use `5603` (backend) and `5103` (frontend) ports.
