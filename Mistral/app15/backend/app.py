```markdown
# Kanban Application Template - Flask + react
...
**Kanban System**  
A task management application built with Flask and react, featuring kanban board functionality.
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=int(os.getenv('PORT', '5109')))
```
...
1. **Port Configuration Prompt**
   - Use `5609` (backend) and `5109` (frontend) ports.
