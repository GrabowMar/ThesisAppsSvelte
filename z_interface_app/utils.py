...
AI_MODELS: List[AIModel] = [
    AIModel("claude-3.7-sonnet", "#D97706"),
    AIModel("gpt-4.1", "#14B8A6"),
    AIModel("devstral-small", "#8B5CF6"),
    AIModel("gemma-3n-e4b-it", "#3B82F6"),
    AIModel("llama-3.3-8b-instruct", "#F59E0B"),
    AIModel("deephermes-3-mistral-24b-preview", "#EC4899"),
    AIModel("phi-4-reasoning-plus", "#6366F1"),
    AIModel("qwen3-30b-a3b", "#F43F5E"),
    AIModel("codex-mini", "#22D3EE"),
    AIModel("grok-3-beta", "#EF4444"),
    AIModel("mercury-coder-small-beta", "#A855F7"),
    AIModel("gemini-2.5-flash-preview-05-20", "#60A5FA"),
    AIModel("llama-4-maverick", "#FBBF24"),
    AIModel("qwen3-32b", "#E11D48"),
    AIModel("llama-4-scout", "#FCD34D"),
    AIModel("deepseek-chat-v3-0324", "#F97316"),
    AIModel("internvl3-14b", "#808080"),
    AIModel("glm-4-32b", "#808080"),
    AIModel("deepcoder-14b-preview", "#808080"),
    AIModel("reka-flash-3", "#808080"),
    AIModel("olympiccoder-32b", "#808080"),
]
